CREATE TABLE `llm_model` (
    `model_key` varchar(1024) PRIMARY KEY NOT NULL COMMENT '模型标识',
    ...
    `bind_im_bot_id` bigint unsigned NOT NULL DEFAULT '0' COMMENT '模型绑定的IM botId',
...
CREATE TABLE IF NOT EXISTS `llm_chat_history` (
    ...
    `im_user_id` bigint NOT NULL DEFAULT 0 COMMENT '用户id',
    `im_bot_id` bigint NOT NULL DEFAULT 0 COMMENT 'IM机器人id',
